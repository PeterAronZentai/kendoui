...
(function(global, $data, undefined) {
  ...
  $data.Entity.extend('NorthwindModel.Customer', {
    ...
    'Contact_Name': { 'type':'Edm.String','maxLength':30 },
    'Contact_Title': { 'type':'Edm.String','maxLength':30 },
    'Address': { 'type':'Edm.String','maxLength':60 },
    'City': { 'type':'Edm.String','maxLength':15 },
    'Region': { 'type':'Edm.String','maxLength':15 },
    'Postal_Code': { 'type':'Edm.String','maxLength':10 },
  ...
  $data.Entity.extend('NorthwindModel.Employee', {
    ...
    'Birth_Date': { 'type':'Edm.DateTime' },
    'Hire_Date': { 'type':'Edm.DateTime' },
    'Address': { 'type':'Edm.String','maxLength':60 },
    'City': { 'type':'Edm.String','maxLength':15 },
    'Region': { 'type':'Edm.String','maxLength':15 },
    'Postal_Code': { 'type':'Edm.String','maxLength':10 },
    'Country': { 'type':'Edm.String','maxLength':15 },
    'Home_Phone': { 'type':'Edm.String','maxLength':24 },
  ...
  $data.Entity.extend('NorthwindModel.Order', {
    ...
    'Employee_ID': { 'type':'Edm.Int32' },
    'Ship_Name': { 'type':'Edm.String','maxLength':40 },
    'Ship_Address': { 'type':'Edm.String','maxLength':60 },
    'Ship_City': { 'type':'Edm.String','maxLength':15 },
    'Ship_Region': { 'type':'Edm.String','maxLength':15 },
    'Ship_Postal_Code': { 'type':'Edm.String','maxLength':10 },
    'Ship_Country': { 'type':'Edm.String','maxLength':15 },
    'Ship_Via': { 'type':'Edm.Int32' },
    'Order_Date': { 'type':'Edm.DateTime' },
    'Required_Date': { 'type':'Edm.DateTime' },
    'Shipped_Date': { 'type':'Edm.DateTime' },
  ...
  $data.Entity.extend('NorthwindModel.Product', {
    ...
    'Supplier_ID': { 'type':'Edm.Int32' },
    'Category_ID': { 'type':'Edm.Int32' },
    'Product_Name': { 'type':'Edm.String','nullable':false,'required':true,'maxLength':40 },
    'English_Name': { 'type':'Edm.String','maxLength':40 },
    'Quantity_Per_Unit': { 'type':'Edm.String','maxLength':20 },
    'Unit_Price': { 'type':'Edm.Decimal' },
    'Units_In_Stock': { 'type':'Edm.Int16' },
    'Units_On_Order': { 'type':'Edm.Int16' },
    'Reorder_Level': { 'type':'Edm.Int16' },
  ...
  $data.EntityContext.extend('NorthwindEntities.NorthwindEntities', {
  ...
  $data.generatedContexts.push(NorthwindEntities.NorthwindEntities);
  
  /*Context Instance*/
  //NorthwindEntities.context = new NorthwindEntities.NorthwindEntities( { name:'oData', oDataServiceHost: 'http://localhost:3708/kendoui/NorthwindService.svc' });
